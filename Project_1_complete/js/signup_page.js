...
function createID(){
  ...
  if(email.value == 'dhzlehzl01@naver.com' && pw.value == pw2.value && checkbox1.checked == true && checkbox2.checked == true && checkbox3.checked == true && 
    checkbox4.checked == true && checkbox5.checked == true && first_name.value != "" && last_name.value != "" && email_allow.style.display == 'block' && gender.value !=""){
